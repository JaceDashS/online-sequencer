...
const casesPath = path.join(__dirname, '..', '..', 'case-tests', 'shortcuts.cases.json');
const raw = fs.readFileSync(casesPath, 'utf8');
const payload = JSON.parse(raw);
const cases = payload.cases || [];
const docPath = payload.document || 'case-tests/shortcuts.md';
...
const printHeader = () => {
  console.log('Shortcuts Test Runner');
