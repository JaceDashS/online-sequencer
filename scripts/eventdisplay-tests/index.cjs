...
const casesPath = path.join(__dirname, '..', '..', 'case-tests', 'eventdisplay.cases.json');
const raw = fs.readFileSync(casesPath, 'utf8');
const payload = JSON.parse(raw);
const cases = payload.cases || [];
const docPath = payload.document || 'case-tests/eventdisplay.md';
...
const printHeader = () => {
  console.log('EventDisplay Test Runner');
